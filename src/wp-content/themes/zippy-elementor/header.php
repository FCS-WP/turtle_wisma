...
<?php handmade_shop_get_header_search_form($cmsmasters_option); ?>

<!-- Start Page -->
<div id="page" class="<?php handmade_shop_get_page_classes($cmsmasters_option); ?>hfeed site">
...
<?php 
handmade_shop_page_heading();


list($cmsmasters_layout, $cmsmasters_page_scheme) = handmade_shop_theme_page_layout_scheme();
