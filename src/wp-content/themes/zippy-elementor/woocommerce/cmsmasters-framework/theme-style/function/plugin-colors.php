...
function handmade_shop_woocommerce_colors($custom_css) {
...
/***************** Start {$title} WooCommerce Color Scheme Rules ******************/
	...
	{$rule}.cmsmasters_product_category_shortcode.puzzle .cmsmasters_products .cmsmasters_product .cmsmasters_product_inner {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['handmade-shop' . '_' . $scheme . '_bg']) . ", 0.95);
	}
...
add_filter('handmade_shop_theme_colors_secondary_filter', 'handmade_shop_woocommerce_colors');
