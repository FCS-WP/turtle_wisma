...
function handmade_shop_yith_woocommerce_zoom_magnifier_colors($custom_css) {
...
add_filter('handmade_shop_theme_colors_secondary_filter', 'handmade_shop_yith_woocommerce_zoom_magnifier_colors');
