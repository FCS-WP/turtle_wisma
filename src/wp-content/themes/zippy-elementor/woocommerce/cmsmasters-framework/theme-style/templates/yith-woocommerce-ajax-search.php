			...
			<div class="yith-ajaxsearchform-container">
				...
				if ( get_option( 'yith_wcas_show_search_list' ) == 'yes' ):
					...
					<select class="yit_wcas_post_type selectbox" id="yit_wcas_post_type" name="post_type">
						<option value="product" <?php selected( 'product', $selected_search ) ?>><?php _e( 'Products', 'handmade-shop' ) ?></option>
						<option value="any" <?php selected( 'any', $selected_search ) ?>><?php _e( 'All', 'handmade-shop' ) ?></option>
					</select>
				...
				if ( get_option( 'yith_wcas_show_category_list' ) == 'yes' ):
					...
					if ( !empty( $product_categories ) ) : ?>
						<select class="search_categories selectbox" id="search_categories" name="product_cat">
							<option value="" <?php selected( '', $selected_category ) ?>><?php _e( 'All', 'handmade-shop' ) ?></option>
				...
				<div class="search-navigation_wrap">
					<div class="search-navigation">
						<label class="screen-reader-text" for="yith-s"><?php _e( 'Search for:', 'handmade-shop' ) ?></label>
						<input type="search"
