	...
	<div class="cmsmasters_post_cont">
		...
		if ($cmsmasters_post_format == 'image') {
			...
			if (sizeof($cmsmasters_post_images) > 0 || has_post_thumbnail()) {
				echo '<div class="cmsmasters_media_wrap">';
					...
					handmade_shop_post_type_slider(get_the_ID(), $cmsmasters_post_images, 'cmsmasters-blog-masonry-thumb', $slider_data);
			...
			echo '<div class="cmsmasters_media_wrap">';
				...
				handmade_shop_thumb(get_the_ID(), 'cmsmasters-blog-masonry-thumb', true, false, true, false, true, true, false);
		...
		if ($author || $date) {
			echo '<div class="cmsmasters_post_cont_info entry-meta">';
				...
				$date ? handmade_shop_get_post_date('page', 'masonry') : '';
				
			echo '</div>';
		}
		
		
		handmade_shop_post_exc_cont();
